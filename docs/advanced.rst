...
Custom History Model Name
-------------------------

By default the history model names are the base model name prefixed with "Historical".
...
The most simple use case is illustrated below:
